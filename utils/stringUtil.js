...
function getWeekNumber(y, m, d) {
  ...
  let aIntWeekCnt=parseInt(days/7);
  let modelWeek=days%7;
  let modelCnt=yearFirstDay==0?(7+modelWeek-1):(modelWeek+yearFirstDay-1);
  //计算是第几周
  var week = aIntWeekCnt+Math.ceil(modelCnt / 7);
  var formatWeek=week>=10?""+week:"0"+week;
  return y+formatWeek;
}
